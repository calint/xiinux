...
public:
  ...
  client_exception(const client_exception &) = delete;
  auto operator=(const client_exception &) -> client_exception & = delete;
  client_exception(client_exception &&) = delete;
  auto operator=(client_exception &&) -> client_exception & = delete;
